...
<html lang="en">
  <head>
    ...
    <!-- vendor css -->
    <link href="<?php echo base_url(); ?>assets/temafront/lib/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/temafront/lib/Ionicons/css/ionicons.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/temafront/lib//chartist/css/chartist.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/temafront/lib//rickshaw/css/rickshaw.min.css" rel="stylesheet">

    <!-- Slim CSS -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/temafront/css/slim.css">
  ...
  <body>
    <div class="slim-header">
      <div class="container">
        <div class="slim-header-left">
          <h2 class="slim-logo"><a href="index.html">SNI<span>.</span></a></h2>
              ...
              <div class="table-responsive">
                <table class="table mg-b-0 tx-13">
                  ...
                  <tbody>
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img28.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img29.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img30.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img31.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img32.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
              ...
              <div class="table-responsive">
                <table class="table mg-b-0 tx-13">
                  ...
                  <tbody>
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img1.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img2.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img3.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img5.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="<?php echo base_url(); ?>assets/temafront/img/img4.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
        ...
        <div class="row row-sm mg-t-20">
            ...
            <div class="card card-info">
              <div class="card-body pd-40">
                <div class="d-flex justify-content-center mg-b-30">
                  <img src="<?php echo base_url(); ?>assets/temafront/img/icon1.svg" class="wd-100" alt="">
                </div>
          ...
          <div class="col-lg-4 mg-t-20 mg-lg-t-0">
            <div class="card card-info">
              <div class="card-body pd-40">
                <div class="d-flex justify-content-center mg-b-30">
                  <img src="<?php echo base_url(); ?>assets/temafront/img/icon2.svg" class="wd-100" alt="">
                </div>
    ...
    <script src="<?php echo base_url(); ?>assets/temafront/lib/jquery/js/jquery.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/lib/popper.js/js/popper.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/lib/bootstrap/js/bootstrap.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/lib/jquery.cookie/js/jquery.cookie.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/lib/chartist/js/chartist.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/lib/d3/js/d3.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/lib/rickshaw/js/rickshaw.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/lib/jquery.sparkline.bower/js/jquery.sparkline.min.js"></script>

    <script src="<?php echo base_url(); ?>assets/temafront/js/ResizeSensor.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/js/dashboard.js"></script>
    <script src="<?php echo base_url(); ?>assets/temafront/js/slim.js"></script>
  </body>
</html>
