...
class Listsni extends CI_Controller {
	...
	public function ajax_list()
    {
        ...
        foreach ($list as $person) {
            ...
            $btntahap  = "<a href='".base_url()."listsni/stagesni/".$person->mbs_id."' data-toggle='tooltip' data-placement='bottom' title='Tahapan Data' class='btn btn-xs btn-flat btn-warning'><i class='fa fa-cog'></i> Stage</a>";
