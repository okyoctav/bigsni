        ...
        <div class="box box-success" style="border-top:#0771ae 6px solid;">
            <div class="box-header">
                <h3 class="box-title">
                  ...
                  <a href="<?php echo base_url(); ?>listnonsni" class="btn btn-sm btn-flat btn-default"><i class="fa fa-caret-left"></i> Back</a>
                </h3>
            </div>
                        ...
                        <td>
                          <?php if($value->tas_groupsession) { ?>
                            <?php if($value->jml_c || $value->jml_d) { ?>
                              <a href="<?php echo base_url(); ?>listnonsni/stagesni_tahap/<?php echo $id; ?>/<?php echo $value->mts_id; ?>" class="btn btn-xs btn-flat btn-primary">Lihat Proses</a>
                            <?php } else { ?>
