        ...
        <div class="box box-success" style="border-top:#0771ae 6px solid;">
            <div class="box-header">
                <h3 class="box-title">
                  ...
                  <a href="<?php echo base_url(); ?>listsni/stagesni/<?php echo $id; ?>" class="btn btn-sm btn-flat btn-default"><i class="fa fa-caret-left"></i> Back</a>
...
<script type="text/javascript">
  ...
  {
            $.ajax({
                    url: base_url+"listsni/modal_uploadfile/<?php echo $idtahap; ?>/<?php echo $id; ?>",
                    cache: false,
  ...
  function savepublish(id,status)
    {
        ...
        if (r == true) {
                  $.ajax({
                      url: base_url+"listsni/savepublish/"+id+"/"+status,
                      cache: false,
                      indicatorId: '#load_ajax',
                      beforeSend: function(){
                          $('#load_ajax').fadeIn(100);
    ...
    function savedelete(id)
    {
        ...
        if (r == true) {
                  $.ajax({
                      url: base_url+"listsni/savedelete/"+id,
                      cache: false,
                      indicatorId: '#load_ajax',
                      beforeSend: function(){
                          $('#load_ajax').fadeIn(100);
    ...
    function selesai()
    {
        ...
        if (r == true) {
                  $.ajax({
                      url: base_url+"listsni/saveselesai/<?php echo $idtahap; ?>/<?php echo $id; ?>",
                      cache: false,
                      indicatorId: '#load_ajax',
                      beforeSend: function(){
                          $('#load_ajax').fadeIn(100);
    ...
    function batalselesai()
    {
        ...
        if (r == true) {
                  $.ajax({
                      url: base_url+"listsni/savebatalselesai/<?php echo $idtahap; ?>/<?php echo $id; ?>",
                      cache: false,
                      indicatorId: '#load_ajax',
                      beforeSend: function(){
                          $('#load_ajax').fadeIn(100);
